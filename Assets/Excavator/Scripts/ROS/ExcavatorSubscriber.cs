...
{
    /// <summary>
    /// RosBridgeClientを利用して油圧ショベルの各アクチュエータのROSトピックにsubscribeし、受けたメッセージの指令値で
    /// ExcavatorのConstraint制御入力を設定するスクリプト。
    /// </summary>
    public class ExcavatorSubscriber : MonoBehaviour
    {
        ...
        void CreateSubscriptions()
        {
            ...
            // このスクリプトがexcavator.UpdateConstraintControlを実行するので、自動的な呼び出しは不要
