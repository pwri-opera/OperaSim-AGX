...
{
    public class OdomPublisher : SingleMessagePublisher<OdomMsg>
    {
        ...
        void UpdateAndPublishMessage()
        {
            ...
            if (time > 0 && deltaTime > 0)
            {
                ...
                double left_vel = dumpTruck.leftSprocket.currentSpeed*wheel_radius;
                double right_vel = dumpTruck.rightSprocket.currentSpeed*wheel_radius;
                ...
                odom.header.frame_id = "ic120_tf/odom";
                odom.child_frame_id = "ic120_tf/base_link";
